...
export interface IEnv {
  ...
  /************************************************************
   * Subsocial - Apillon subsocial Service
   ************************************************************/
  /**
   *  function name
   */
  SUBSOCIAL_FUNCTION_NAME: string;
  SUBSOCIAL_FUNCTION_NAME_TEST: string;

  /**
   * SUBSOCIAL dev server port
   */
  SUBSOCIAL_SOCKET_PORT: number;
  SUBSOCIAL_SOCKET_PORT_TEST: number;

  /**
   * SUBSOCIAL Database config
   */

  SUBSOCIAL_MYSQL_HOST: string;
  SUBSOCIAL_MYSQL_PORT: number;
  SUBSOCIAL_MYSQL_USER: string;
  SUBSOCIAL_MYSQL_PASSWORD: string;
  SUBSOCIAL_MYSQL_DEPLOY_USER: string;
  SUBSOCIAL_MYSQL_DEPLOY_PASSWORD: string;
  SUBSOCIAL_MYSQL_DATABASE: string;

  // TEST
  SUBSOCIAL_MYSQL_HOST_TEST: string;
  SUBSOCIAL_MYSQL_PORT_TEST: number;
  SUBSOCIAL_MYSQL_USER_TEST: string;
  SUBSOCIAL_MYSQL_PASSWORD_TEST: string;
  SUBSOCIAL_MYSQL_DATABASE_TEST: string;

  /**
   * SUBSOCIAL workers config
   */
  SUBSOCIAL_AWS_WORKER_SQS_URL: string;
  SUBSOCIAL_AWS_WORKER_LAMBDA_NAME: string;
}
...
export let env: IEnv = {
  ...
  /** SUBSOCIAL */
  SUBSOCIAL_FUNCTION_NAME: process.env['SUBSOCIAL_FUNCTION_NAME'],
  SUBSOCIAL_FUNCTION_NAME_TEST: process.env['SUBSOCIAL_FUNCTION_NAME_TEST'],
  SUBSOCIAL_SOCKET_PORT: parseInt(process.env['SUBSOCIAL_SOCKET_PORT']) || 6102,
  SUBSOCIAL_MYSQL_HOST: process.env['SUBSOCIAL_MYSQL_HOST'],
  SUBSOCIAL_MYSQL_PORT: parseInt(process.env['SUBSOCIAL_MYSQL_PORT']) || 3306,
  SUBSOCIAL_MYSQL_DATABASE: process.env['SUBSOCIAL_MYSQL_DATABASE'],
  SUBSOCIAL_MYSQL_USER: process.env['SUBSOCIAL_MYSQL_USER'],
  SUBSOCIAL_MYSQL_PASSWORD: process.env['SUBSOCIAL_MYSQL_PASSWORD'],
  SUBSOCIAL_MYSQL_DEPLOY_USER: process.env['SUBSOCIAL_MYSQL_DEPLOY_USER'],
  SUBSOCIAL_MYSQL_DEPLOY_PASSWORD:
    process.env['SUBSOCIAL_MYSQL_DEPLOY_PASSWORD'],

  SUBSOCIAL_SOCKET_PORT_TEST:
    parseInt(process.env['SUBSOCIAL_SOCKET_PORT_TEST']) || 7102,
  SUBSOCIAL_MYSQL_HOST_TEST: process.env['SUBSOCIAL_MYSQL_HOST_TEST'],
  SUBSOCIAL_MYSQL_PORT_TEST:
    parseInt(process.env['SUBSOCIAL_MYSQL_PORT_TEST']) || 3306,
  SUBSOCIAL_MYSQL_DATABASE_TEST: process.env['SUBSOCIAL_MYSQL_DATABASE_TEST'],
  SUBSOCIAL_MYSQL_USER_TEST: process.env['SUBSOCIAL_MYSQL_USER_TEST'],
  SUBSOCIAL_MYSQL_PASSWORD_TEST: process.env['SUBSOCIAL_MYSQL_PASSWORD_TEST'],

  SUBSOCIAL_AWS_WORKER_SQS_URL: process.env['SUBSOCIAL_AWS_WORKER_SQS_URL'],
  SUBSOCIAL_AWS_WORKER_LAMBDA_NAME:
    process.env['SUBSOCIAL_AWS_WORKER_LAMBDA_NAME'],
