...
export let env: IEnv = {
  ...
  /** HOSTING */
  DEPLOY_FUNCTION_NAME: process.env['HOSTING_FUNCTION_NAME'],
  DEPLOY_FUNCTION_NAME_TEST: process.env['HOSTING_FUNCTION_NAME_TEST'],
  DEPLOY_SOCKET_PORT: parseInt(process.env['HOSTING_SOCKET_PORT']) || 6902,
  DEPLOY_MYSQL_HOST: process.env['HOSTING_MYSQL_HOST'],
  DEPLOY_MYSQL_PORT: parseInt(process.env['HOSTING_MYSQL_PORT']) || 3306,
  DEPLOY_MYSQL_DATABASE: process.env['HOSTING_MYSQL_DATABASE'],
  DEPLOY_MYSQL_USER: process.env['HOSTING_MYSQL_USER'],
  DEPLOY_MYSQL_PASSWORD: process.env['HOSTING_MYSQL_PASSWORD'],
  DEPLOY_MYSQL_DEPLOY_USER: process.env['HOSTING_MYSQL_DEPLOY_USER'],
  DEPLOY_MYSQL_DEPLOY_PASSWORD: process.env['HOSTING_MYSQL_DEPLOY_PASSWORD'],

  DEPLOY_SOCKET_PORT_TEST:
    parseInt(process.env['HOSTING_SOCKET_PORT_TEST']) || 7902,
  DEPLOY_MYSQL_HOST_TEST: process.env['HOSTING_MYSQL_HOST_TEST'],
  DEPLOY_MYSQL_PORT_TEST:
    parseInt(process.env['HOSTING_MYSQL_PORT_TEST']) || 3306,
  DEPLOY_MYSQL_DATABASE_TEST: process.env['HOSTING_MYSQL_DATABASE_TEST'],
  DEPLOY_MYSQL_USER_TEST: process.env['HOSTING_MYSQL_USER_TEST'],
  DEPLOY_MYSQL_PASSWORD_TEST: process.env['HOSTING_MYSQL_PASSWORD_TEST'],
  ...
  DEPLOY_PHALA_CLOUD_API_KEY: process.env['HOSTING_PHALA_CLOUD_API_KEY'],
