...
export async function upgrade(
  ...
  await queryFn(`
    ...
    VALUES 
    (${QuotaCode.MAX_PROJECT_COUNT}, 5, 'Project', 'Project count limit', 'Number of max project owned by user', 1, 10),
    ...
    (${QuotaCode.MAX_HOSTING_BUCKETS}, 5, 'Storage', 'Number of hosting buckets', 'Max number of buckets for web hosting', 1, 5),
    (${QuotaCode.MAX_FILE_BUCKETS}, 5, 'Storage', 'Number of file buckets', 'Max number of buckets for file hosting', 1, 5),
    (${QuotaCode.MAX_BUCKET_SIZE}, 5, 'Storage', 'Bucket size limit in GB', 'Max size of files in bucket', 1, 5),
