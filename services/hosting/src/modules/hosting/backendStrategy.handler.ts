...
import { IBackendHostingStrategy } from './types';
import { Backend } from './models/backend.model';
import { v4 as uuidV4 } from 'uuid';

export class BackendStrategyHandler {
  private readonly context: ServiceContext;
  private readonly strategy: IBackendHostingStrategy;
  private logging: Lmas;

  constructor(
    context: ServiceContext,
    hostingStrategy: IBackendHostingStrategy,
    logging: Lmas,
  ) {
    this.context = context;
    this.strategy = hostingStrategy;
