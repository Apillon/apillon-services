  ...
  return {
    host:
      env.APP_ENV === AppEnvironment.TEST
        ? env.HOSTING_MYSQL_HOST_TEST
        : env.HOSTING_MYSQL_HOST,
    port:
      env.APP_ENV === AppEnvironment.TEST
        ? env.HOSTING_MYSQL_PORT_TEST
        : env.HOSTING_MYSQL_PORT,
    database:
      env.APP_ENV === AppEnvironment.TEST
        ? env.HOSTING_MYSQL_DATABASE_TEST
        : env.HOSTING_MYSQL_DATABASE,
    user:
      env.APP_ENV === AppEnvironment.TEST
        ? env.HOSTING_MYSQL_USER_TEST
        : env.HOSTING_MYSQL_USER,
    password:
      env.APP_ENV === AppEnvironment.TEST
        ? env.HOSTING_MYSQL_PASSWORD_TEST
        : env.HOSTING_MYSQL_PASSWORD,
  };
};
