  ...
  return {
    host:
      env.APP_ENV === AppEnvironment.TEST
        ? env.ASSET_MANAGEMENT_MYSQL_HOST_TEST
        : env.ASSET_MANAGEMENT_MYSQL_HOST,
    port:
      env.APP_ENV === AppEnvironment.TEST
        ? env.ASSET_MANAGEMENT_MYSQL_PORT_TEST
        : env.ASSET_MANAGEMENT_MYSQL_PORT,
    database:
      env.APP_ENV === AppEnvironment.TEST
        ? env.ASSET_MANAGEMENT_MYSQL_DATABASE_TEST
        : env.ASSET_MANAGEMENT_MYSQL_DATABASE,
    user:
      env.APP_ENV === AppEnvironment.TEST
        ? env.ASSET_MANAGEMENT_MYSQL_USER_TEST
        : env.ASSET_MANAGEMENT_MYSQL_USER,
    password:
      env.APP_ENV === AppEnvironment.TEST
        ? env.ASSET_MANAGEMENT_MYSQL_PASSWORD_TEST
