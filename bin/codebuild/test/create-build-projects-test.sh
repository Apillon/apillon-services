...
aws codebuild create-project --cli-input-json file://computing-config-test.json  --profile apillon
aws codebuild create-webhook --cli-input-json file://computing-webhook-test.json  --profile apillon
