...
const sampleJsonConfig = {
  ...
  environment: {
    ...
    environmentVariables: [
      ...
      },
      {
        type: 'PLAINTEXT',
        name: 'S3_CONFIG',
        value: 'XXXs3://env.yml#s3://apillon-services-config/env.test.yml',
      },
      {
        type: 'PLAINTEXT',
        name: 'SERVICE_PATH',
  ...
  sourceVersion: 'XXXsourceVersion#test',
  source: {
    insecureSsl: false,
    gitSubmodulesConfig: {
  ...
  logsConfig: {
    ...
    cloudWatchLogs: {
      status: 'ENABLED',
      groupName: 'codebuild',
      streamName: 'XXXcloudWatch#apillon-services-test',
    },
  },
...
const sampleJsonWebhook = {
  ...
  filterGroups: [
    [
      ...
      {
        pattern: 'XXXbranch-paterrn#refs/heads/test$',
        type: 'HEAD_REF',
        excludeMatchedPattern: false,
      },
    ],
