...
const sampleJsonConfig = {
    ...
    environmentVariables: [
      {
        type: 'PLAINTEXT',
        name: 'ENV',
        value: 'XXXENV#staging',
      },
      {
        type: 'PLAINTEXT',
        name: 'S3_CONFIG',
        value: 'XXXs3://env.yml#s3://apillon-services-config/env.staging.yml',
      },
      {
        type: 'PLAINTEXT',
        name: 'SERVICE_PATH',
      ...
      },
      {
        type: 'PLAINTEXT',
        name: 'AWS_SECRETS_ID',
        value: 'XXXAWS_SECRETS_ID#apillon-staging',
      },
    ],
  ...
  sourceVersion: 'XXXsourceVersion#stage',
  source: {
    insecureSsl: false,
    gitSubmodulesConfig: {
  ...
  logsConfig: {
    ...
    cloudWatchLogs: {
      status: 'ENABLED',
      groupName: 'codebuild',
      streamName: 'XXXcloudWatch#apillon-services-staging',
    },
  },
...
const sampleJsonWebhook = {
  ...
  filterGroups: [
    [
      ...
      {
        pattern: 'XXXbranch-paterrn#refs/heads/stage$',
        type: 'HEAD_REF',
        excludeMatchedPattern: false,
      },
    ],
