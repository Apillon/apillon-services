...
aws codebuild update-project --cli-input-json file://auth-api-config-prod.json --profile apillon
aws codebuild update-project --cli-input-json file://computing-api-config-prod.json --profile apillon
