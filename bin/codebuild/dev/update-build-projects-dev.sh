...
aws codebuild update-project --cli-input-json file://social-config-dev.json --profile apillon
aws codebuild update-webhook --cli-input-json file://social-webhook-dev.json --profile apillon
