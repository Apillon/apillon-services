...
const sampleJsonConfig = {
    ...
    environmentVariables: [
      {
        type: 'PLAINTEXT',
        name: 'ENV',
        value: 'XXXENV#development',
      },
      {
        type: 'PLAINTEXT',
        name: 'S3_CONFIG',
        value: 'XXXs3://env.yml#s3://apillon-services-config/env.dev.yml',
      },
      {
        type: 'PLAINTEXT',
        name: 'SERVICE_PATH',
  ...
  sourceVersion: 'XXXsourceVersion#develop',
  source: {
    insecureSsl: false,
    gitSubmodulesConfig: {
  ...
  logsConfig: {
    ...
    cloudWatchLogs: {
      status: 'ENABLED',
      groupName: 'codebuild',
      streamName: 'XXXcloudWatch#apillon-services-dev',
    },
  },
...
const sampleJsonWebhook = {
  ...
  filterGroups: [
    [
      ...
      {
        pattern: 'XXXbranch-paterrn#refs/heads/develop$',
        type: 'HEAD_REF',
        excludeMatchedPattern: false,
      },
    ],
