...
aws sqs create-queue --queue-name apillon-authentication-queue-dev-dlq --attributes file://dev/authentication-queue-dev-dlq.json --region eu-west-1
aws sqs create-queue --queue-name apillon-authentication-queue-dev --attributes file://dev/authentication-queue-dev.json  --region eu-west-1
