...
// export async function verificationFlow(credential: ICredential, signCallback: SignCallback) {
//   const api = ConfigService.get('api');
//   const challenge = getChallenge();

//   const presentation = await createPresentation(credential, signCallback, challenge);
