...
export enum ModuleValidatorErrorCode {
  ...
  DID_CREATE_INVALID_REQUEST = 42207011,
  DID_CREATE_PAYLOAD_NOT_PRESENT = 42207011,
  DID_CREATE_SENDER_KEY_NOT_PRESENT = 42207012,
  VERIFICATION_IDENTITY_NOT_PRESENT = 42207015,
  VERIFICATION_CHALLENGE_NOT_PRESENT = 42207016,
  VERIFICATION_INVALID_CHALLENGE = 42207017,
}
